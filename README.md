...
For full details, see the [Command Line Reference](https://github.com/Unity-Billal-mesloub/debugpy/wiki/Command-Line-Reference).
...
For full details, see the [API reference](https://github.com/Unity-Billal-mesloub/debugpy/wiki/API-Reference).
